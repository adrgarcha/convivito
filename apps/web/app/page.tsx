    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-green-200 to-orange-200">
      <nav className="flex justify-between px-4 py-3">
        <div className="flex items-center gap-x-2">
          <Image src="/convivito.png" alt="El logo de Convivito" width={1200} height={1200} className="size-12" priority />
          <h1 className="text-lg font-bold">Convivito</h1>
        </div>
        <a href="https://github.com/adrgarcha/convivito" target="_blank" rel="noopener noreferrer" className="h-fit">
          <Button className="group hover:cursor-pointer">
            <span>Mira este proyecto en GitHub</span>
            <ArrowRight className="group-hover:translate-x-0.5 transition-transform" />
          </Button>
        </a>
      </nav>
      <main className="grid grid-cols-2 grow px-16">
        <div className="w-xl mt-52">
          <h2 className="text-5xl font-bold mb-3">Gestiona tu convivencia <br /> desde WhatsApp</h2>
